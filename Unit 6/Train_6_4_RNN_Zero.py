...
print("前10个corpus_indices:", corpus_indices[:10])
print("数据类型:", type(corpus_indices))
d2l.train_and_predict_rnn(
    rnn, get_params, init_rnn_state, num_hiddens, vocab_size, device,
    corpus_indices, char_to_idx, idx_to_char, True, num_epochs, num_steps,
